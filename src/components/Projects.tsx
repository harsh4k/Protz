...
export default function Projects() {
  ...
  // Position of floating cursor preview
  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto px-6 md:px-16 w-full">
          ...
          {PROJECTS.map((project, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-6 md:gap-14 flex-1">
                ...
                {/* Huge title that slides slightly on hover */}
              ...
              <div className="flex flex-col md:flex-row flex-1 items-start md:items-center justify-between gap-6 py-4 md:py-0">
                ...
                {/* Tech Tags - Outlined & Brutalist (no rounded corners) */}
              ...
              {/* Row Right Side - Arrow */}
              <div className="flex items-center justify-end pl-4">
                <div className="p-3 border border-transparent group-hover:border-[rgba(240,237,232,0.15)] group-hover:bg-[#F0EDE8] group-hover:text-[#0A0A0A] transition-all duration-500 rounded-none text-text-sec">
        ...
        {/* Floating Custom Graphic Preview matching Cursor with absolute positioning */}
        {/* Only rendered on medium screen and above to keep high performance */}
        ...
        {/* Mobile View Active Image Display */}
